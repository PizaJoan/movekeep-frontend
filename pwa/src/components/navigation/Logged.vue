    ...
    >
        <q-toolbar slot="header">
            <q-tabs class="col-md-12">
                <router-link to="/" tag="img" v-if="$q.platform.is.desktop" slot="title" class="avatar self-center" src="./../../statics/logo-movekeep-working-png-big.png" alt="logo">
                </router-link>    
                <q-tab 
                    slot="title" 
        ...
        <q-toolbar slot="footer">
            <q-toolbar-title class="toolbar-flex">
                <img class="logo-footer" alt="logo" src="./../../statics/logo-movekeep-working-png-big.png" /> 
                Movekeep
            </q-toolbar-title>
        </q-toolbar>
    </q-layout>
